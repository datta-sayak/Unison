  ...
  return (
    <main className="min-h-screen bg-background flex flex-col">
      ...
      <div ref={contentRef} className="flex-1 overflow-y-auto">
        ...
        {/* Chat Section */}
        {activeSection === "chat" && (
          <ChatSection messages={messages} newMessage={newMessage} setNewMessage={setNewMessage} handleSendMessage={handleSendMessage} />
        )}

        {/* Info Section */}
        {activeSection === "info" && (
          <InfoSection roomId={roomId} allUsers={allUsers} queue={queue} handleCopyLink={handleCopyLink} handleLeaveRoom={handleLeaveRoom} />
        )}
      </div>
