...
export default function CreateRoomPage() {
  ...
  const handleCreateRoom = async () => {
    ...
    try {
      const payload: { email?: string; roomName?: string; isPrivate?: boolean; password?: string } = {}
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="bg-card rounded-2xl p-8 shadow-sm border border-border space-y-6">
          ...
          <div className="space-y-2">
            <Label htmlFor="roomName" className="text-sm font-medium text-foreground">Room Name</Label>
            <Input
              id="roomName"
          ...
          {isPrivate && (
            <div className="space-y-2 animate-in slide-in-from-top-2 duration-200">
              <Label htmlFor="roomPassword" className="text-sm font-medium text-foreground">Room Password</Label>
              <Input
                id="roomPassword"
                type="password"
